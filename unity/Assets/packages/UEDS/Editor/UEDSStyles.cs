...
namespace UEDS
{
	public static class UEDSStyles
	{
		public const string kImagePath ="Assets/packages/UEDS/Editor/images/";
		...
		public static GUIStyle detailsTitle
		{
			get
			{
				if(mDetailsTitle == null)
				{
					...
					mDetailsTitle.fontSize = 24;
					mDetailsTitle.normal.textColor = Color.white;
		...
		public static GUIContent openFileContent
		{
			get 
			{
				if(mOpenFileContent == null)
				{
					...
					mOpenFileContent.image =  (Texture2D)AssetDatabase.LoadAssetAtPath(UEDSStyles.kImagePath + "open.png", typeof(Texture2D));
		...
		public static GUIContent saveFileContent
		{
			get 
			{
				if(mSaveFileContent == null)
				{
					...
					mSaveFileContent.image =  (Texture2D)AssetDatabase.LoadAssetAtPath(UEDSStyles.kImagePath + "save.png", typeof(Texture2D));
		...
		public static GUIContent dupInstanceContent
		{
			get
			{
				if(mDupInstanceContent == null)
				{
					...
					mDupInstanceContent.image =  (Texture2D)AssetDatabase.LoadAssetAtPath(UEDSStyles.kImagePath + "duplicate.png", typeof(Texture2D));
		...
		public static GUIContent addInstanceContent
		{
			get 
			{
				if(mAddInstanceContent == null)
				{
					...
					mAddInstanceContent.image =  (Texture2D)AssetDatabase.LoadAssetAtPath( UEDSStyles.kImagePath + "add.png", typeof(Texture2D));
		...
		public static GUIContent delInstanceContent
		{
			get 
			{
				if(mDelInstanceContent == null)
				{
					...
					mDelInstanceContent.image =  (Texture2D)AssetDatabase.LoadAssetAtPath(UEDSStyles.kImagePath + "delete.png", typeof(Texture2D));
		...
		public static GUIContent renameInstanceContent
		{
			get 
			{
				if(mRenameInstanceContent == null)
				{
					...
					mRenameInstanceContent.image =  (Texture2D)AssetDatabase.LoadAssetAtPath(UEDSStyles.kImagePath + "rename.png", typeof(Texture2D));
